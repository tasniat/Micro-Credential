...
-- 6. A customer left us some feedback about our store. Write a query to find her email address – for
-- Nancy Thomas.
SELECT * FROM CUSTOMER
WHERE FIRST_NAME = 'Nancy' AND LAST_NAME = 'Thomas'

-- 7. We’re trying to find a customer located at a certain address ‘259 Ipoh Drive’ – can you find their
-- phone number?
...
-- 10. Write a query to return a list of transitions from the payment table where the amount is greater
-- than 5.
SELECT * FROM PAYMENT
WHERE AMOUNT > '5'